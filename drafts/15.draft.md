...
| **Threshold Flexibility** | Fixed `>85% disk`, `<500 MB RAM` | Hard‑coded values; dynamic thresholds would require additional configuration management |
...
- **Tools Used**  
  ...
  - `df` and `free` for disk/ram metrics (warning thresholds: disk >85%, RAM <500MB free).  
