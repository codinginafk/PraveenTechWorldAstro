...
function insertLineAfter(content, search, newLine) {
  ...
  // If search is followed by a newline, insert before the newline
  if (afterChar === '\n' || afterChar === '\r') {
    return content.slice(0, endIdx) + '\n' + newLine + content.slice(endIdx);
  }
  // If search is in the middle of a line, add a newline after it then our text
  return content.slice(0, endIdx) + '\n' + newLine + content.slice(endIdx);
}

// For each article, get actual H2/H3 headings
const headings = {};
...
// Now define insertions using actual heading text
const spec = {
  'how-to-build-a-website-from-scratch-in-2026-a-complete-beginner-guide.mdx': {
    ...
    cite: { search: 'Wix alone powers over 200 million websites globally, making it one of the most popular website builders in the world', text: '([Statista](https://www.statista.com/statistics/1137020/wix-com-total-subscribers/))' }
  },
  'seo-basics-how-to-rank-higher-on-google-in-2026.mdx': {
    links: [
  ...
  'technical-seo-checklist-for-beginners-fix-these-issues-to-rank-better.mdx': {
    links: [
  ...
  'backlink-building-guide-for-new-websites-get-your-first-quality-links.mdx': {
    ...
    cite: { search: "Google's guidelines clearly state that buying links to pass PageRank violates their spam policies", text: '([Google Search Central](https://developers.google.com/search/docs/essentials/spam-policies))' }
  },
  ...
  'website-speed-optimization-why-it-matters-for-seo-and-how-to-fix-it.mdx': {
    ...
    cite: { search: 'Core Web Vitals', text: 'Learn more at [web.dev/vitals](https://web.dev/vitals/).' }
  },
  ...
  'how-to-set-up-google-search-console-for-your-new-website.mdx': {
    ...
    cite: { search: 'Google Search Console is a free tool from Google that helps you monitor and troubleshoot your site', text: '([Google Search Central](https://developers.google.com/search/docs/fundamentals/get-on-google))' }
  },
  ...
  'how-to-use-chatgpt-to-summarize-long-pdfs-for-free.mdx': {
    ...
    cite: { search: 'ChatGPT Plus offers priority access to GPT-4 and additional features like Code Interpreter', text: '([OpenAI Documentation](https://platform.openai.com/docs/guides/text-generation))' }
  },
  'chatgpt-has-been-tracking-everything-you-say-heres-how-to-see-what-it-knows.mdx': {
    ...
    cite: { search: 'OpenAI provides detailed documentation on how ChatGPT memory works and how data is used', text: '([OpenAI Privacy Policy](https://openai.com/policies/privacy-policy/))' }
  },
  'how-to-remove-your-personal-information-from-google-search-results-2026-guide.mdx': {
    links: [
      ...
      { heading: '## Using Google's Own "Results About You" Tool: Your First Line of Defense', text: 'Our guide on [ChatGPT memory tracking](/blog/chatgpt-has-been-tracking-everything-you-say-heres-how-to-see-what-it-knows) covers similar data removal topics.' },
    ],
  ...
  'how-to-fix-windows-11-update-errors-in-2026-step-by-step-troubleshooting-guide.mdx': {
    links: [
    ...
    cite: { search: 'Windows Update errors can be caused by corrupted system files or incorrect configuration', text: '([Microsoft Support](https://support.microsoft.com/en-us/windows/fix-windows-update-errors))' }
  },
  ...
  'chatgpt-for-excel-how-to-use-new-financial-data-integrations-2024-guide.mdx': {
    links: [
    ...
    cite: { search: 'ChatGPT can integrate with Microsoft Excel through official add-ins and plugins', text: '([Microsoft Excel API](https://learn.microsoft.com/en-us/office/dev/add-ins/))' }
  },
  'microsoft-free-ai-for-teachers-students-how-to-access-and-use-copilot-now.mdx': {
    links: [
    ...
    cite: { search: 'Microsoft Copilot for Education offers free AI access to students and teachers with eligible school accounts', text: '([Microsoft Learn](https://learn.microsoft.com/en-us/training/modules/empower-educators-with-ai-and-copilot/))' }
  },
  'speed-up-your-slow-pc-in-2026-10-essential-windows-performance-tweaks.mdx': {
    links: [
    ...
    cite: { search: 'A 2025 study by a software analytics firm found that the average Windows 11 PC sees a 40% slowdown', text: '([Microsoft PC Manager](https://learn.microsoft.com/en-us/windows/pc-manager/))' }
  },
  'how-to-automate-your-daily-workflow-with-free-tools-in-2026-complete-guide.mdx': {
    ...
    cite: { search: 'Knowledge workers spend a significant portion of their day on work about work rather than strategic tasks', text: '([Zapier Guides](https://zapier.com/guides))' }
  },
  'android-battery-draining-fast-after-update-7-proven-fixes-for-2026.mdx': {
    ...
    cite: { search: 'Android updates often trigger background optimization processes that temporarily increase battery drain', text: '([Google Battery Health](https://support.google.com/pixelphone/answer/9601185))' }
  },
  'chrome-removes-ai-privacy-wording-what-googles-on-device-data-claim-means-for-us.mdx': {
    links: [
  ...
  'chatgpt-usage-and-adoption-patterns-at-work-in-2026-what-the-data-shows.mdx': {
    ...
    cite: { search: 'OpenAI publishes regular research on how ChatGPT is being used across different industries', text: '([OpenAI Research](https://openai.com/research/))' }
  },
  'best-password-managers-in-2026-security-features-and-pricing-compared.mdx': {
    ...
    cite: { search: 'In 2024 alone, over 80% of confirmed data breaches involved a stolen or weak password', text: '([NIST Password Guidelines](https://pages.nist.gov/800-63-3/))' }
  },
  'ai-to-automate-office-work-in-1218-months-microsofts-ceo-predictions-and-practic.mdx': {
    links: [
    ...
    cite: { search: 'Microsoft predicts that AI agents will handle the majority of routine office tasks within the next two years', text: '([Microsoft AI](https://www.microsoft.com/en-us/ai))' }
  },
  'best-free-vpn-services-in-2026-complete-comparison-and-privacy-guide.mdx': {
    links: [
  ...
  'why-ai-usage-is-dropping-math-skills-in-berkeley-cs-classes-and-what-students-ca.mdx': {
    links: [
    ...
    cite: { search: 'Studies from leading universities show a correlation between AI tool usage and declining performance on closed-book exams', text: '([Berkeley EECS](https://eecs.berkeley.edu/resources/students))' }
  },
  'ai-in-higher-education-protecting-student-data-privacy-essential-tips-and-regula.mdx': {
    links: [
    ...
    cite: { search: 'EDUCAUSE conducts annual surveys on AI adoption trends in higher education institutions', text: '([EDUCAUSE AI](https://www.educause.edu/topics/artificial-intelligence))' }
  },
  'is-chatgpt-safe-2026-security-privacy-guide.mdx': {
    ...
    cite: { search: 'OpenAI publishes a transparency report detailing security incidents and privacy safeguards', text: '([OpenAI Trust](https://openai.com/trust/))' }
  },
  'how-to-learn-excel-faster-using-chatgpt.mdx': {
    links: [
    ...
    cite: { search: 'Microsoft Excel supports over 500 built-in functions for data analysis and calculation', text: '([Microsoft Excel Help](https://support.microsoft.com/en-us/excel))' }
  },
};
...
for (const [file, s] of Object.entries(spec)) {
  ...
  if (idx === -1) {
    ...
    // Find the end of the sentence containing the search text
