...
description: "Step-by-step guide to fix 'Crawled - currently not indexed' and 'Discovered - currently not indexed' errors in Google Search Console. Troubleshoot index coverage issues and get your pages into Google."
...
Google's crawl budget is limited. Do not waste it on low-value pages. The [how Google indexing works guide](/blog/how-google-indexing-works-crawl-index-serve-explained) explains crawl budget in more detail.
