---
title: "How I Retooled My AI Content Pipeline After Audit (Case Study)"
description: "Our team had an expert audit our AI article pipeline. They scored each component and told us to throw out half of it. Here is the before/after with code"
...
draft: false
faq:
  - question: "What is Information Density in SEO?"
    answer: "Information density is a concept measuring the ratio of facts and entities to word count. However, relying on strict mathematical formulas for this is not recommended, as search engines prioritize genuine evidence and readability over density metrics."
  - question: "Should every H2 heading be a question?"
    answer: "No. While question headings can help target specific search queries, forcing every H2 to be a question makes the article read artificially. Aim for a natural mix, typically keeping question headings to 30-50% of the total."
  - question: "What is an Obsidian RAG?"
    answer: "An Obsidian RAG (Retrieval-Augmented Generation) is an AI setup that searches through your local Obsidian notes to pull context before generating content. This ensures the AI writes based on your actual knowledge and experiments."
---
You know how sometimes you think you're doing everything right, only to find out that half of it isn't working? That's exactly what happened when our team had a [technical SEO](/blog/technical-seo-checklist-for-beginners-fix-these-issues-to-rank-better) expert take a look at our AI article pipeline. Out of 12 components, only 5 were really doing their job. Ouch, right? Three were just taking up space, and one was actually messing things up!

Let's dive into what we changed and why it matters.

## 1. The Original Pipeline

After cranking out over 70 articles, our system had become a bit of a tangled mess. Here's what we had:

- A made-up **Information Density formula** (`(entities + facts) / word count`) that we thought measured article quality  
...
We really thought this was a solid setup. The expert kindly pointed out how misguided we were.
...
## References & Further Reading for How I Retooled My AI Content Pipeline After Audit (Case Study)
- [Wikipedia: Content marketing](https://en.wikipedia.org/wiki/Content_marketing)
