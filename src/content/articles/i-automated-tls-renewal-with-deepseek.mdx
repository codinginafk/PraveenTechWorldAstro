...
description: "I automated TLS renewal across 25 Nginx servers with a DeepSeek-orchestrated bash pipeline using Cloudflare DNS-01, automated rollback on failure."
coverImage: "/images/generated/i-automated-tls-renewal-with-deepseek.svg"
imageAlt: "I Automated TLS Renewal with DeepSeek conceptual design"
...
socialHook: "DeepSeek orchestrated a 5-stage TLS renewal pipeline across 25 Nginx servers. Automated rollbacks caught failures before they hit production."
---
...
# Install DeepSeek CLI — see https://docs.deepseek.com for current instructions
```
...
# ---- CONFIG -------------------------------------------------
# Configurable Variables (DeepSeek orchestrates)
