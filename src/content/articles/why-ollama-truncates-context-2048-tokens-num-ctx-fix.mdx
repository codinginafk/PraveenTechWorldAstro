...
description: "Why Ollama silently truncates prompts at 2048 tokens: the hidden num_ctx bug in Open WebUI, API, and Modelfiles, and how to fix RAG drops."
...
draft: false
featured: true
seoTitle: "Fix Ollama 2048 Context Truncation: num_ctx Guide"
