...
**Jump to a section:**
- [Event ID 153 Triage Decision Matrix](#event-id-153-triage-decision-matrix)
- [Step 1: Capture Event and Probe Telemetry](#step-1-capture-event-and-probe-telemetry)
- [Step 2: Test Disabling GPU Scheduling](#step-2-test-disabling-gpu-scheduling)
- [Step 3: Avoid Risky TDR Registry Hacks](#step-3-avoid-risky-tdr-registry-hacks)
- [Step 4: Verify PCIe Link and 12V Power](#step-4-verify-pcie-link-and-12v-power)
- [Step 5: Clean DDU Driver Purge in Safe Mode](#step-5-clean-ddu-driver-purge-in-safe-mode)
- [Related GPU and Driver Diagnostic Guides](#related-gpu-and-driver-diagnostic-guides)
...
## Step 4: Verify PCIe Link and 12V Power
...
## Related GPU and Driver Diagnostic Guides
