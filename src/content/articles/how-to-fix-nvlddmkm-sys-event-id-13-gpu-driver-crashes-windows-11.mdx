...
**Jump to a section:**
- [Windows GPU Sub-System & TDR Fault Traversal](#windows-gpu-sub-system--tdr-fault-traversal)
- [Event ID 13 Payload Decoding Matrix](#event-id-13-payload-decoding-matrix)
- [What nvlddmkm Event ID 13 Actually Means](#what-nvlddmkm-event-id-13-actually-means)
- [Did an Update Trigger the GPU Crash?](#did-an-update-trigger-the-gpu-crash)
- [When to Use DDU in Safe Mode](#when-to-use-ddu-in-safe-mode)
- [Avoid Risky TdrDelay Registry Modifications](#avoid-risky-tdrdelay-registry-modifications)
- [Power, Thermal, and Overclocking Causes](#power-thermal-and-overclocking-causes)
- [Isolating RAM and PCIe Hardware Faults](#isolating-ram-and-pcie-hardware-faults)
- [Safe Windows and NVIDIA Settings to Test](#safe-windows-and-nvidia-settings-to-test)
- [When Event 13 Signals Failing Hardware](#when-event-13-signals-failing-hardware)
- [Final nvlddmkm Event ID 13 Checklist](#final-nvlddmkm-event-id-13-checklist)
