---
title: "Fix nvlddmkm.sys Event ID 13 GPU Crashes"
description: "Fix nvlddmkm.sys Event ID 13 on Windows 11 with an evidence-first checklist for driver cleanup, power, thermals, overclocks, and hardware faults."
...
tags:
  ...
  - "troubleshooting"
  - "drivers"
seoTitle: "Fix nvlddmkm.sys Event ID 13 GPU Crashes"
socialHook: "Fix nvlddmkm.sys Event ID 13 on Windows 11 with a checklist for drivers, power, heat, overclocks, and hardware faults."
faq:
