...
coverImage: "/images/articles/how-to-run-qwen-3-6-27b-local-vision-llm.jpg"
imageAlt: "Minimal flat editorial illustration of an optical camera aperture lens centered over a neural pixel grid with an alert amber sensor chip"
