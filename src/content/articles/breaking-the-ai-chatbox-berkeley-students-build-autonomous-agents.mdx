...
title: "How Berkeley CS Students Built Autonomous Agents (Step"
...
tags:
  ...
  - "playwright"
  - "llm"
seoTitle: "How Berkeley CS Students Built Autonomous Agents (Step"
...
faq:
  - question: "What is an Agent-Computer Interface (ACI)?"
    answer: "An Agent-Computer Interface (ACI) is a specialized set of commands designed specifically for LLMs to interact with a computer, replacing raw shell commands with structured, context-limited actions."
  - question: "Why do AI web agents get blocked by Cloudflare?"
    answer: "Cloudflare and other CDNs use advanced browser fingerprinting to detect headless browsers used by agents. Bypassing them requires stealth extensions, residential proxies, and active session management."
  - question: "What is visual grounding in AI agents?"
    answer: "Visual grounding is a technique where an AI uses computer vision (via vision models like GPT-4o) to look at a screenshot and determine the x/y coordinates of an element, rather than relying on brittle CSS or XPath selectors."

---
## 1. The Agent-Computer Interface Paradigm

Most people think building an autonomous AI agent is about picking the right model. It's not. In our team's experience building automated test rigs, the bottleneck is always the **interface** — how the model talks to the computer.
...
---
## 2. Architecture: The ACI Pattern
...
---
## 3. Visual Grounding: Beyond Brittle Selectors
...
```python
## 3. await page.get_by_role("button", name="Submit Order").click()
```bash
...
---
## 4. Anti-Detection: The Cat-and-Mouse Game
...
## 5. from playwright_stealth import stealth_sync
...
---
## 5. State Machines and Checkpointing
...
---
## 6. Budget Enforcement: Preventing Runaway Costs
...
To see how we optimize agent memory windows, check out our guide on [Why AI Coding Agents Truncate Context](/blog/why-ai-coding-agents-truncate-context-memory-token-optimization).

---

## Related Guides

- [How to Set Cost Caps & Retry Limits for LLM Pipelines](/blog/cost-caps-retry-limits-for-llm-agent-pipelines) — Prevent infinite agent loops and catastrophic API token spend.
