...
- [I Built a Log Monitoring Script with DeepSeek â€” Here is What Went Wrong](/blog/i-built-a-log-monitoring-script-with-deepseek-here-is-what-went-wrong) â€” The short answer is I built a log monitoring Python script using DeepSeek, but the generated code hallucinated and needed a lot of manual fixing.
- [How I Automated TLS Certificate Renewal with DeepSeek â€” Production Lessons](/blog/how-i-automated-tls-certificate-renewal-with-deepseek-and-why-it-almost-broke-pr) â€” The short answer is I automated TLS certificate renewal using a DeepSeek-generated Python script, but it almost broke production.
- [I Asked DeepSeek to Build My Sysadmin Toolkit â€” Here is What It Made and Broke](/blog/i-asked-deepseek-to-build-my-sysadmin-toolkit-here-is-what-it-made-and-broke) â€” The short answer is I asked DeepSeek to build a complete sysadmin toolkit, and it generated scripts that looked great but had hidden bugs.
