...
description: "A clean Windows reinstall fixes slow performance from software bloat or corrupted files. But not if your hardware is old. Here is what to do."
coverImage: "https://images.unsplash.com/photo-1517430816045-df4b7de11d1d?ixid=M3w5NjkzNDF8MHwxfHNlYXJjaHwxfHxzbG93JTIwY29tcHV0ZXJ8ZW58MHwwfHx8MTc4MDk0NjE3Nnww&ixlib=rb-4.1.0&w=1200&h=600&fit=crop"
imageAlt: "Person working on laptop computer"
imageCredit: "freestocks on Unsplash"
...
references:
  ...
  - title: "Microsoft PC Manager"
    url: "https://learn.microsoft.com/en-us/windows-apps/pc-manager/"
...
5.  **Run System File Checker (SFC):**
    ...
    *   Type `sfc /scannow` and press Enter. This scans for and attempts to repair corrupted Windows system files. For more on this, our [SFC scannow guide](https://praveentechworld.com/sfc-scannow-windows) details the process and what to do if it fails.
