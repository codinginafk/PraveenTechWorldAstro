...
description: "My team hit $2,300 in AI API costs in one month with no idea where it went. I built a token burn dashboard with SQLite and a middleware proxy. Here is what the data showed and how we cut costs."
...
tags:
  ...
  - sqlite
  - cost optimization
seoTitle: "I Built an AI Token Dashboard and Cut API Costs 60%"
