---
title: "I Built an AI Token Dashboard and Tracked Every API Call for 30 Days. My Bill Dropped 60%."
...
tags:
  ...
  - sqlite
  - cost optimization
seoTitle: "I Built an AI Token Dashboard and Tracked Every API Call for 30 Days. My Bill Dropped 60%."
...
Every AI agent burns tokens. Most teams have no idea how many. I built a transparent HTTP proxy that sits between every service and every LLM provider. For a closer look at how browser-level AI features handle your data, read our [Chrome AI privacy analysis](/blog/chrome-removes-ai-privacy-wording-what-googles-on-device-data-claim-means-for-us). It logs each request — model, prompt length, completion length, latency, cost — to a local SQLite database. A simple dashboard queries that database and shows cost by agent, cost by user, cost trend over time. Within a week, I identified two agents responsible for 40% of our total cost doing redundant work. I merged them, added prompt caching, and the bill dropped from $2,300 to $920.
