...
coverImage: "https://images.unsplash.com/photo-1657812160299-6b656decd5b1?ixid=M3w5NjkzNDF8MHwxfHNlYXJjaHwxfHxVbmRlcnN0YW5kaW5nJTIwU2l0ZW1hcCUyMEluZGV4aW5nfGVufDB8fHx8MTc4MTcyODk5MHww&ixlib=rb-4.1.0&w=800&h=400&fit=crop"
...
The disconnect is simple: a sitemap tells Google your pages exist, but it does not force Google to index them. Indexing depends on content quality, site authority, and technical setup. The sitemap is just the invitation. Google still decides whether to walk through the door.
...
**Blocked by robots.txt.** If your sitemap URL or any page listed in it is blocked by `robots.txt`, Google may still discover the URL but cannot crawl it. Check your robots.txt file — I once blocked half my site by accidentally adding a `Disallow: /blog/` rule.
