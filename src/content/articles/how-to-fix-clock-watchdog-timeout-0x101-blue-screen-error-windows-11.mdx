---
title: "Fix CLOCK_WATCHDOG_TIMEOUT (0x101) in Windows 11"
description: "Fix CLOCK_WATCHDOG_TIMEOUT (0x101) crashes in Windows 11. Learn why it survives reinstalls, how to isolate CPU cores in WinDbg, and BIOS voltage fixes."
...
target_query: "clock watchdog timeout 0x101"
tags:
  - "windows-fixes"
  - "bsod"
  - "cpu"
...
One of the most frustrating aspects of `CLOCK_WATCHDOG_TIMEOUT` is that users frequently perform a [clean Windows 11 reinstallation](/blog/does-resetting-windows-remove-viruses-completely), only for the exact same `0x101` crash to reappear within hours. Just as with [KMODE_EXCEPTION_NOT_HANDLED (0x1E)](/blog/how-to-fix-kmode-exception-not-handled-0x1e-blue-screen) and [nvlddmkm GPU crashes](/blog/how-to-fix-nvlddmkm-sys-event-id-13-gpu-driver-crashes-windows-11), jumping directly to reinstalling the operating system treats the software surface while leaving the underlying hardware failure active.
...
**Jump to a section:**
- [Why 0x101 Survives Clean Reinstalls](#why-0x101-survives-clean-reinstalls)
- [Bugcheck 0x101 Triage Decision Matrix](#bugcheck-0x101-triage-decision-matrix)
- [Inspect the WinDbg Memory Dump](#inspect-the-windbg-memory-dump)
- [Run the PowerShell Diagnostic Probe](#run-the-powershell-diagnostic-probe)
- [Reset BIOS Voltage and Curve Profiles](#reset-bios-voltage-and-curve-profiles)
- [Flash Motherboard Microcode Updates](#flash-motherboard-microcode-updates)
- [Reinstall Vendor Chipset Drivers](#reinstall-vendor-chipset-drivers)
- [Repair Corrupted Windows System Files](#repair-corrupted-windows-system-files)
- [Inspect CPU Cooler Mounting and Thermals](#inspect-cpu-cooler-mounting-and-thermals)
- [Diagnostic Summary Checklist](#diagnostic-summary-checklist)
- [Related Hardware Diagnostic Runbooks](#related-hardware-diagnostic-runbooks)
