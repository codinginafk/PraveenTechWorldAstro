---
title: "I Asked DeepSeek to Build My Sysadmin Toolkit — Here Is What It Made (and Broke)"
...
tags:
  ...
  - cli-tools
  - it-automation
seoTitle: "I Built a Sysadmin Toolkit with DeepSeek — Prompts, Failures & Code"
...
I didn't start with a generic "write me a script" prompt. I've learned from previous experiments-like when I tried to automate my [cloud backup pipeline](https://praveentechworld.com/cloud-backup-automation)-that specificity is everything. I gave the AI a persona and a strict set of requirements.
...
I've uploaded the final, cleaned-up scripts to my GitHub repo [here](https://github.com/PraveenTechWorld/sysadmin-toolkit) for anyone who wants to fork it.
