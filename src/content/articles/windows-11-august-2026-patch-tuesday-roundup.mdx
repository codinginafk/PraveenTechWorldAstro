...
For the game and RGB regression Microsoft lists for KB5121003, use [the detailed inpoutx64 troubleshooting guide](/blog/how-to-fix-windows-11-kb5121003-inpoutx64-crash). It explains the reversible `Start=4` test; do not remove a kernel driver automatically just because it appears in a forum checklist.
