...
description: "If your new website fails Core Web Vitals before publishing, fix the loading path first: compress the hero image, reserve image and embed space, and"
