...
Yes, resetting Windows will remove most common viruses and malware, but not all of them. A "Keep my files" reset often fails to eliminate deeply embedded threats like rootkits or firmware-level malware. For complete removal, a "Remove everything" reset or a clean install from external media is required.
