...
Filters are another common cause. GA4 data filters can remove internal traffic, developer traffic, or traffic marked with a specific `traffic_type`. Google’s official [GA4 data filters documentation](https://support.google.com/analytics/answer/9308878) explains that data filters control which events are included in reports. I’ve seen setups where the office IP was added correctly, but the filter was too broad and removed visitors from the same network range.
