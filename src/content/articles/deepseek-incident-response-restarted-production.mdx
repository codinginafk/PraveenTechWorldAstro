...
description: "DeepSeek wrote an incident response script. It restarted production during peak hours, deleted crash logs, and had zero safety checks. The exact prompt and fixes."
...
tags:
  ...
  - cli-tools
  - it-automation
seoTitle: "DeepSeek Incident Response Automation — Production Restart Disaster"
