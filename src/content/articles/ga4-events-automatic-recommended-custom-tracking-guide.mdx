...
description: "Automatic, recommended, or custom GA4 events â€” learn the difference and how to track button clicks, form submissions, file downloads, and scroll depth."
...
- `session_start` â€” each new session
- `first_visit` â€” first time a user visits your site
- `user_engagement` â€” page is in focus for 10+ seconds
...
- `view_item` â€” someone viewed a product
- `add_to_cart` â€” product added to cart
- `purchase` â€” completed transaction
- `remove_from_cart` â€” product removed

If you run a content or lead generation site, Google recommends:
- `generate_lead` â€” form submission
- `sign_up` â€” account creation
- `share` â€” content shared via social
...
- `article_read` â€” fires when a reader scrolls past 75% of an article
- `tool_used` â€” tracks when someone opens a free tool on my site
- `newsletter_signup` â€” fires on email form submission (since I want extra parameters beyond the default)
